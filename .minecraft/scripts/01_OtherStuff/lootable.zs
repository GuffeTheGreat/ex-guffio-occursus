...
LootTables.getTable("minecraft:chests/abandoned_mineshaft").removePool("bewitchment_materials_pool");
LootTables.getTable("minecraft:chests/abandoned_mineshaft").removePool("silver_ingot");
