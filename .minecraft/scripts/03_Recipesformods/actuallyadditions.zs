...
mods.actuallyadditions.Empowerer.addRecipe(<actuallyadditions:item_crystal_empowered:1>, <actuallyadditions:item_crystal:1>, <alchemistry:ingot:72>, <silentgems:gemsuper:42>, <iceandfire:sea_serpent_scales_deepblue>, <requious:lapotron>, 500, 100);
