...
var hardRecipes as IItemStack[IItemStack] = {
  ...
  <actuallyadditions:block_testifi_bucks_green_slab> : <actuallyadditions:block_testifi_bucks_green_wall>,
  <actuallyadditions:block_testifi_bucks_white_slab> : <actuallyadditions:block_testifi_bucks_white_wall>,
  <actuallyadditions:block_quartz_slab> : <actuallyadditions:block_misc:2>,
  <actuallyadditions:block_chiseled_quartz_slab> : <actuallyadditions:block_misc:1>,
  <actuallyadditions:block_pillar_quartz_slab> : <actuallyadditions:block_misc>,
