...
Carving.addVariation("guidebooks", <zawa:care_guide>);
Carving.addVariation("guidebooks", <hammercore:manual>);
Carving.addVariation("guidebooks", <geolosys:field_manual>);
Carving.addVariation("guidebooks", <zawa:exploration_guide>);
Carving.addVariation("guidebooks", <gbook:guidebook>.withTag({Book: "rockhounding_chemistry:xml/chembook.xml"}));
