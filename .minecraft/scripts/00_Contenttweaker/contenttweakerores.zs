...
ember.setBlockResistance(5.0);
ember.setToolClass("pickaxe");
ember.setToolLevel(0);
ember.setBlockSoundType(<soundtype:stone>);
ember.setSlipperiness(0.6);
ember.setPassable(false);
ember.register();
/*
//graphite
