...
addRatTableRecipe([<rats:rat_upgrade_blacklist>],[<rats:rat_upgrade_basic>,<enderio:item_material:77>,<essentials:sorting_hopper>],30);
...
addRatTableRecipe([<rats:rat_upgrade_farmer>],[<rats:rat_upgrade_basic>,<minecraft:hay_block>*4,<primal:emerald_hoe>,<rats:farmer_hat>],120);
...
addRatTableRecipe([<rats:rat_upgrade_milker>],[<rats:rat_upgrade_bucket>,<primal:pelt_cow>*16,<minecraft:milk_bucket>],60);